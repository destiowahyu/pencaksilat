...
--
-- Host: localhost:3306
-- Generation Time: Jul 31, 2025 at 02:57 PM
...
(5, 5, 4, '1752423874_6873ddc2424e4.jpg', 'ariq', '1111237738849979', 'L', '2015-02-03', 'semarang', 'SDN 01 KOTA SEMARANG', '45.00', '160.00', '2025-07-13 16:24:34', '2025-07-13 16:24:34');
...
CREATE TABLE `bracket_results` (
  ...
  `round` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `match_id` int NOT NULL,
  `winner_player_id` int NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `kategori_umur` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kelamin` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kompetisi` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kategori_tanding` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(312, 24, '1', 4, 4, '2025-07-31 10:11:41', '2025-07-31 10:11:41', 'REMAJA', 'L', 'TANDING', 'TANDING KELAS A'),
(313, 24, '1', 6, 8, '2025-07-31 10:11:41', '2025-07-31 10:11:41', 'REMAJA', 'L', 'TANDING', 'TANDING KELAS A'),
(314, 24, '1', 8, 10, '2025-07-31 10:11:41', '2025-07-31 10:11:41', 'REMAJA', 'L', 'TANDING', 'TANDING KELAS A'),
(315, 26, '1', 4, 4, '2025-07-31 21:45:11', '2025-07-31 21:45:11', 'PRA REMAJA', 'L', 'TANDING', 'TANDING KELAS C'),
(316, 26, '1', 6, 8, '2025-07-31 21:45:31', '2025-07-31 21:45:31', 'PRA REMAJA', 'L', 'TANDING', 'TANDING KELAS C'),
(317, 26, '1', 8, 10, '2025-07-31 21:45:31', '2025-07-31 21:45:31', 'PRA REMAJA', 'L', 'TANDING', 'TANDING KELAS C');
...
CREATE TABLE `competitions` (
  `id` int NOT NULL,
  `nama_perlombaan` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
  `lokasi` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `maps_link` text COLLATE utf8mb4_general_ci,
  `whatsapp_group` text COLLATE utf8mb4_general_ci,
  `kontak_panitia` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('coming_soon','open_regist','close_regist','active','finished','inactive') COLLATE utf8mb4_general_ci DEFAULT 'coming_soon',
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `registration_status` enum('auto','coming_soon','open_regist','close_regist') COLLATE utf8mb4_general_ci DEFAULT 'auto'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Kejuaraan Pencak Silat Nasional 2024', 'Kejuaraan pencak silat tingkat nasional untuk kategori junior dan senior dengan berbagai kelas tanding dan tunggal.', 'GOR Soemantri Brodjonegoro, Jakarta', NULL, NULL, NULL, 'active', NULL, NULL, '2024-03-15', NULL, '2024-01-14 18:00:00', '2024-01-14 18:00:00', 'auto'),
...
(6, 'KENDAL CHAMPIONSHIP', 'ddd', 'Gor bahurekso', 'https://maps.app.goo.gl/NFfzfSyfXrAwZCPs5', 'https://chat.whatsapp.com/IC11ZcShREtHxJ2H1K2fjX?mode=r_t', NULL, 'active', '2025-07-31', '2025-08-01', '2025-08-16', '1752338877_687291bd5392c.png', '2025-07-12 16:40:55', '2025-07-13 14:32:48', 'open_regist');
...
(1, 1, 2, '2024-01-15 18:30:00'),
(3, 5, 2, '2025-06-22 22:18:25'),
(4, 6, 2, '2025-07-12 16:46:48');
...
CREATE TABLE `competition_categories` (
  ...
  `jenis_kelamin` enum('L','P','Campuran') COLLATE utf8mb4_general_ci DEFAULT 'Campuran',
  `competition_type_id` int DEFAULT NULL,
  `tipe_kelas` enum('Berat','Tinggi','Lengan','Umur','Campuran') COLLATE utf8mb4_general_ci DEFAULT 'Berat',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `competition_contacts` (
  ...
  `nama_kontak` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `nomor_whatsapp` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
(3, 1, 'Panitia Nasional', '08111222333', 'Ketua Umum', '2025-07-12 17:11:18'),
...
CREATE TABLE `competition_documents` (
  `id` int NOT NULL,
  `competition_id` int NOT NULL,
  `nama_dokumen` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
(9, 1, 3, '2025-07-12 17:00:58'),
(10, 6, 3, '2025-07-12 17:00:58'),
(12, 6, 5, '2025-07-12 17:02:49'),
(13, 5, 5, '2025-07-12 17:02:49');
...
CREATE TABLE `competition_types` (
  `id` int NOT NULL,
  `competition_id` int NOT NULL,
  `nama_kompetisi` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `jenis_kelamin` enum('L','P','Campuran') COLLATE utf8mb4_general_ci DEFAULT 'Campuran',
...
CREATE TABLE `daftar_peserta` (
  ...
  `kontingen` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `kategori_umur` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `jenis_kompetisi` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `kategori_tanding` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `daftar_peserta_draws` (
  ...
  `urutan` text COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `daftar_peserta_filter_batches` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `kategori_umur` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kelamin` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kompetisi` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kategori_tanding` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `kontingen` (
  `id` int NOT NULL,
  `user_id` int DEFAULT NULL,
  `nama_kontingen` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `payment_methods` (
  ...
  `nomor_rekening` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `pemilik_rekening` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `registrations` (
  ...
  `payment_status` enum('unpaid','paid','verified') COLLATE utf8mb4_general_ci DEFAULT 'unpaid',
  `payment_proof` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `age_category_id` int DEFAULT NULL,
  `competition_type_id` int DEFAULT NULL,
  `payment_note` text COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(8, 6, 4, 5, 'pending', 'paid', '1752492180_6874e8948ccf3.jpg', '2025-07-14 10:11:32', '2025-07-14 11:23:00', 7, 17, NULL),
(9, 6, 5, NULL, 'pending', 'verified', 'kontingen_payment_1752492825_6874eb191141c.jpg', '2025-07-14 11:23:33', '2025-07-14 11:45:14', 6, 5, NULL);
