...
// Get competition categories (for tanding)
$stmt = $pdo->prepare("
    SELECT cc.*, ac.nama_kategori as age_category_name 
    FROM competition_categories cc 
    JOIN age_categories ac ON cc.age_category_id = ac.id 
    WHERE cc.competition_id = ? 
    ORDER BY ac.nama_kategori, cc.nama_kategori
");
$stmt->execute([$competition_id]);
$competition_categories = $stmt->fetchAll();

// Get documents from competition_documents
$stmt = $pdo->prepare("SELECT * FROM competition_documents WHERE competition_id = ?");
$stmt->execute([$competition_id]);
$documents = $stmt->fetchAll();

// Get contacts from competition_contacts
            ...
            <div class="competition-header">
                ...
                <div class="competition-meta">
                    <div class="meta-item">
                        ...
                        <span style="color:#2563eb !important; font-weight:700;"><?php echo formatDate($competition['tanggal_pelaksanaan']); ?></span>
                    </div>
                    <div class="meta-item">
                        <i class="fas fa-map-marker-alt" style="color:#2563eb !important;"></i>
                        <span style="color:#2563eb !important; font-weight:700;"><?php echo htmlspecialchars($competition['lokasi'] ?? 'TBA'); ?></span>
                    </div>
                    <div class="meta-item">
                        <i class="fas fa-users" style="color:#2563eb !important;"></i>
                        <span style="color:#2563eb !important; font-weight:700;"><?php echo $total_registrations; ?> Pendaftar</span>
                    </div>
                </div>
                ...
                <div class="section-body">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo formatDate($competition['tanggal_pelaksanaan']); ?></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <?php echo formatDate($competition['tanggal_open_regist']); ?> - 
                                <?php echo formatDate($competition['tanggal_close_regist']); ?>
                            </div>
                        </div>
                    </div>
