...
<div class="competition-detail-modal">
    <!-- Modal Header -->
    <div class="modal-header-detail">
        <h2><i class="fas fa-trophy"></i> <?php echo htmlspecialchars($competition['nama_perlombaan']); ?></h2>
        <button class="close-detail-modal" onclick="closeCompetitionDetailModal()">&times;</button>
    </div>
            ...
            <div class="category-list">
                ...
                <div class="category-item">
                    <div class="category-header">
                        ...
                        <span class="age-range"><?php echo $cat['usia_min']; ?>-<?php echo $cat['usia_max']; ?> tahun</span>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="modal-footer-detail">
        ...
        <?php endif; ?>
        <button class="btn-close-modal" onclick="closeCompetitionDetailModal()">
